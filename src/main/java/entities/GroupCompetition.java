...
public class GroupCompetition implements Serializable {
    ...
    private Long idGroupCompetition;
    ...
    public GroupCompetition(Long idGroupCompetition) {
        this.idGroupCompetition = idGroupCompetition;
    }

    public Long getIdGroupCompetition() {
        return idGroupCompetition;
    }

    public void setIdGroupCompetition(Long idGroupCompetition) {
        this.idGroupCompetition = idGroupCompetition;
    }
